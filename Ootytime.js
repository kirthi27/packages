...
import cardImg1 from "./Gallery/ooty1.jpeg";
import cardImg2 from "./Gallery/ooty2.jpeg";
import cardImg3 from "./Gallery/ooty3.jpeg";
    ...
    <>
      ...
      <Offcanvas.Header closeButton>
         <Offcanvas.Title className="mt-3 text-center ">
           <h3 className="text-center mx-5" style={{width:"220px"}} >Best Time To visit In  Ooty  </h3>
         </Offcanvas.Title>
       </Offcanvas.Header>
       <Offcanvas.Body>
       <h6 className="fw-bold" >Ooty in Summer (March - June) </h6>
       <p style={{linespacing:"2px" ,textIndent: "6rem", textAlign: "justify" }} >Ooty experiences an average temperature that ranges between 23 degree Celsius and 31 degree Celsius, which is perfect for you to explore the sheer beauty cf th's place it full swing.</p>
       <h6 className="fw-bold" >Ooty in Winter (October - March) </h6>
       <p style={{linespacing:"2px" ,textIndent: "6rem", textAlign: "justify" }} >With temperatures that stay below 15 degree Celsius, winters in Ooty are perfect to have a gala time. Each year, during January or February, Department of Tourism in Tamil Nadu hosts The Tea and Tourism Festival for three days. A vast range of tea leaves are displayed, and rows of tea stalls are put up for tasting and buying a wide variety of tea. In addition to this, these three days are packed with cultural shows and performances, which reverberate with the heritage of the Nilgiris. </p>
       <h6 className="fw-bold" >Ooty in Monsoon (July - September) </h6>
       <p style={{linespacing:"2px" ,textIndent: "6rem", textAlign: "justify" }} >People who love rainfall and green grass beds laid over mountains can pack their bags and head straight to Ooty during the monsoon months, which lasts between June and September. Even though you are unlikely to experierce the bright warm sunshine, you will have a great time nevertheless.</p>
       </Offcanvas.Body>
      </Offcanvas>
    </>
  );
...
function Ootytime() {
  ...
  return (
    <div>
      <h3 style={{marginTop:"150px",marginLeft:"60px"}} >04.Ooty</h3>
      <div className="d-flex">
        <div style={{ marginLeft:"0px", marginTop: "10px" }}>
          ...
          >
            <Card style={{ width: "600px",height:"500px" }} className="ms-4">
        ...
        <div style={{ width: "575px",marginLeft: "40px" }}>
