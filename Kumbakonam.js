...
import cardImg1 from "./Gallery/kumbakonam1.jpeg";
import cardImg2 from "./Gallery/kumbakonam2.jpeg";
import cardImg3 from "./Gallery/kumbakonam3.jpeg";
    ...
    <>
      ...
      <Offcanvas.Header closeButton>
         <Offcanvas.Title className="mt-3 text-center ">
           <h3 className="text-center mx-5" style={{width:"220px"}} >Best Time To visit In  Kumbakonam</h3>
         </Offcanvas.Title>
       </Offcanvas.Header>
       <Offcanvas.Body>
       <h6 className="fw-bold" >Kumbakonam in Winter (October - February)  </h6>
       <p style={{linespacing:"2px" ,textIndent: "6rem", textAlign: "justify" }} >The winters in Kumbakonam are pleasantly cold, with light sweaters helping you to survive the cold. The temperature ranges from 15 to 25 degrees Celcius, and the diurnal range of temperature isn't more than a maximum of 10 degrees Celcius. This season is most preferred by tourists to visit Kumbakonam, as exploring the city in this weather becomes comfortable and the temperature is pleasing most of the time during winter months. </p>
       <h6 className="fw-bold" >Kumbakonam in Monsoon (June - August) </h6>
       <p style={{linespacing:"2px" ,textIndent: "6rem", textAlign: "justify" }} >The monsoon is associated with frequent and untimely shower spells in the region. The temperature drops down considerably after the scorching summers and the place witness a waste stretch of greenery as the rains give life to the flora of the region. The rains can though be problematic at times and can interfere with your exploration plans, but overall this season can also be preferred by tourists to pay a visit to Kumbakonam. </p>
       <h6 className="fw-bold" >Kumbakonam in Summer (March - May)  </h6>
       <p style={{linespacing:"2px" ,textIndent: "6rem", textAlign: "justify" }} >Summers in the Deccan region of the country is undeniable hot, and the scorching sun might be an unpleasant experience. The summers are usually arid and heated up, and the temperature goes up to 40 degrees Celcius during the day. The season is majody avoided by tourists to plan a visit to Kumbakonam because of the overall weather conditions.</p>
       </Offcanvas.Body>
      </Offcanvas>
    </>
  );
...
function Kumbakonam() {
  ...
  return (
    <div>
      <h3 style={{marginTop:"100px"}} >06. Kumbakonam </h3>
      <div className="d-flex">
        <div style={{ marginLeft:"0px", marginTop: "10px" }}>
          ...
          >
            <Card style={{ width: "600px",height:"400px" }} className="ms-4">
