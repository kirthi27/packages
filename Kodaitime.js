...
import cardImg1 from "./Gallery/kodaikanal1.jpeg";
import cardImg2 from "./Gallery/kodaikanal2.jpeg";
import cardImg3 from "./Gallery/kodaikanal3.jpeg";
    ...
    <>
      ...
      <Offcanvas.Header closeButton>
         <Offcanvas.Title className="mt-3 text-center ">
           <h3 className="text-center mx-5" style={{width:"220px"}} >Best Time To visit In Kodaikanal </h3>
         </Offcanvas.Title>
       </Offcanvas.Header>
       <Offcanvas.Body>
       <h6 className="fw-bold" >Kodaikanal in Summer ( March-June )</h6>
       <p style={{linespacing:"2px" ,textIndent: "6rem", textAlign: "justify" }} >Summers (March to June) in Kodaikanal is ideal with comfortable 20 degree Celsius to 32 degree Celsius temperature and flowers in full bloom.The ten days long Grand Annual Summer Festival, which takes place in May, attracts many tourists. From elegant fruit exhibitions to enthralling boat races, flower art-wort, classical dance performances and melodious musicals, the Summer Festival is a platter of different shows. Kodaikanal also holds fantastic festivals like Panguni Uthiram in March and the Annual Horticulture Show in May. </p>
       <h6 className="fw-bold" >Kodaikanal in Winter ( December-February )</h6>
       <p style={{ textIndent: "6rem", textAlign: "justify" }} >Summers (March to June) in Kodaikanal is ideal with comfortable 20 degree Celsius to 32 degree Celsius temperature and flowers in full bloom.The ten days long Grand Annual Summer Festival, which takes place in May, attracts many tourists. From elegant fruit exhibitions to enthralling boat races, flower art-works, classical dance performances and melodious musicals, the Summer Festival is a platter of different shows. Kodaikanal also holds fantastic festivals like Panguni Uthiram in March and the Annual Horticulture Show in May.</p>
       <h6 className="fw-bold" >Kodaikanal in Monsoon (June-September)</h6>
       <p style={{ textIndent: "6rem", textAlign: "justify" }} >With a temperature that rarely falls below 8 degree Celsius, winter in Kodaikanal (between December and February) is the best time to enjoy various treks, and attend the famous Pongal festival celebrated during January. </p>
       </Offcanvas.Body>
      </Offcanvas>
    </>
  );
...
//   const handleShowCard = () => setShowCard(true);
  ...
  return (
    <div>
      <div className="d-flex" style={{marginTop: "150px", marginLeft:"40px"}}>
        ...
        <div style={{ marginLeft: "40px", marginTop: "10px" }}>
          ...
          >
            <Card style={{ width: "500px" }} className="ms-4">
